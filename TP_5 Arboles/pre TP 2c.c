...
void encontrarNodo(nodoArbol* raiz)
{
    ...
    nodoArbol* aux = buscarNodo(raiz, op);

    if (aux != NULL)
    {

        printf("El elemento %i, se encuentra en el arbol. \n", aux->dato);
    }
    else
    {
        printf("El elemento %i, no se encuentra en el arreglo. \n", op);
    }
}

void mostrarTresFormas(nodoArbol* raiz){
